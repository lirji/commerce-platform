...
会员能力覆盖周期等级与保级、周期权益、积分赚取/账本/过期/退款债务/兑换和订单抵扣、行为画像、人群、定向券、生日/沉睡/复购/加购旅程及效果比较。商品支持类目、固定规格模板、图文、条码、检索、批量定时上下架/调价、可信渠道价。前端提供深色经营总览、折叠搜索导航和手机布局。操作顺序、统计口径与边界见 [本轮运营手册](docs/delivery/member-lifecycle-catalog-ui/OPERATIONS_GUIDE.md)。
