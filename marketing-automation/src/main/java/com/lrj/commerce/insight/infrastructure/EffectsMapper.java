...
public interface EffectsMapper {
 record Fact(String orderId,String storeId,String seriesId,String campaignId,Long campaignVersion,Instant orderedAt,boolean paid,String paidAmount,String refunded,String discountAmount,String platformFunding,String merchantFunding) { }
