...
public class CatalogMerchandisingService implements CatalogMerchandisingApi {
 private final java.time.Clock clock;private final MerchandisingMapper mapper;private final ProductMapper products;private final StoreAccessApi access;private final StoreApi stores;private final Commands commands;
 public CatalogMerchandisingService(MerchandisingMapper mapper,ProductMapper products,StoreAccessApi access,StoreApi stores,Commands commands,java.time.Clock clock){this.clock=clock;this.mapper=mapper;this.products=products;this.access=access;this.stores=stores;this.commands=commands;}
