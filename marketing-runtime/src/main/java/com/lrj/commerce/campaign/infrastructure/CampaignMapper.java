...
public interface CampaignMapper {
    record Row(String campaignId,long version,String storeId,String merchantId,String name,Instant validFrom,Instant validTo,String minimumSpend,String discountAmount,String ruleJson,String status,long lockVersion,String policyJson) { }
    void insert(@Param("tenant") String tenant,@Param("merchant") String merchant,@Param("input") Draft input,@Param("rule") String rule,@Param("policy") String policy);
