...
public class CampaignFundingService implements CampaignFundingApi {
    ...
    private CampaignApi.Terms terms(CampaignMapper.Row row){var policy=row.policyJson()==null?null:JsonCodec.read(row.policyJson(),CampaignApi.Policy.class);return policy==null||policy.terms()==null?new CampaignApi.Terms(0,0,null):policy.terms();}
