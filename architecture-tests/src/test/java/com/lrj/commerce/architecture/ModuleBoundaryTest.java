...
class ModuleBoundaryTest {
    @Test void persistedModulesOnlyReachOtherDomainsThroughApi() throws Exception {
        ...
        for(String module:List.of("shared-kernel","platform-runtime","member","merchant","store","catalog","marketing","marketing-runtime","trade","inventory","order","order-runtime","payment")) {
