...
public interface QuoteApi {
    ...
    record Line(String skuId,long revision,String title,int quantity,String unitPrice,String gross,String discount,String payable,Long points,String pointDiscount) {
        public Line { points=points==null?0L:points; pointDiscount=pointDiscount==null?"0.00":pointDiscount; }
        public Line(String skuId,long revision,String title,int quantity,String unitPrice,String gross,String discount,String payable){this(skuId,revision,title,quantity,unitPrice,gross,discount,payable,0L,"0.00");}
    }
